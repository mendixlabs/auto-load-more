...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		copy: {
			distDeployment: {
				files: [{
					dest: "../../Atlas-main/deployment/web/widgets",
					cwd: "./dist/tmp/src/",
					src: ["**/*"],
					expand: true
				}]
		...
		clean: {
			build: [
				...
				"./dist/tmp/**/*",
				"../../Atlas-main/deployment/web/widgets/" + pkg.widgetName + "/*",
				"../../Atlas-main/widgets/" + pkg.widgetName + ".mpk"
			]
		},
	...
	grunt.registerTask(
		"clean build",
		"Compiles all the assets and copies the files to the dist directory.", ["checkDependencies", "clean:build", "webpack:develop", "file_append", "compress:dist", "copy:mpk"]
	);
	grunt.registerTask(
		"release",
		"Compiles all the assets and copies the files to the dist directory. Minified without source mapping", ["checkDependencies", "clean:build", "webpack:release", "file_append", "compress:dist", "copy:mpk"]
	);
